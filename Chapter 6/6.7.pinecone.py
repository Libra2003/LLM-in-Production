...
class WikiDataIngestion:
    def __init__(
        ...
        self.embedder or OpenAIEmbeddings(
    ...
    def batch_upload(self):
        ...
        for page in tqdm(self.wikidata):
            texts, batch_metadatas = self.split_text_and_metadatas(page)
...
if __name__ == "__main__":
    index_name = "pinecone-llm-example"
    ...
    if index_name not in pc.list_indexes().names():
        pc.create_index(
            ...
            spec=ServerlessSpec(cloud="aws", region="us_east-1"),
        )
    ...
    result = index.query(vector=embeddings, top_k=3, include_metadata=True)
    print(results)
