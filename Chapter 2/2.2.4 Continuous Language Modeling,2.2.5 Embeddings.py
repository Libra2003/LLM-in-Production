...
with open("C:/Users/hp envy/OneDrive/Desktop/LLM IN Production/data/hamlet.txt", "r", encoding="utf-8") as f:
    data = f.read()
...
# Get our Bag of Words, along with a disribution
fdlist = nltk.FreqDist(word for word in data)
print("Size of vocabulary:", len(fdlist))
print("Most Frequent Tokens:", fdlist.most_common(20))

# Create 2 dictionaris to speed up time-to-convert and keep track of vocabulary
...
# Here we create our Neural network with 1 layer an 2 parameters
...
def gradient_descent(data, word2Ind, N, V, num_itre, alpha=0.03):
    """
