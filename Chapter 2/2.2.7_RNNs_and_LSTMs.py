...
dataset = pd.read_csv("C:/Users/hp envy/OneDrive/Desktop/LLM IN Production/data/twitter.csv")
text_data = list(
...
EMBEDDING_DIM = 100
model_path = "my_word2vec.model"

# Check if the model already exists on your hard drive
if os.path.exists(model_path):
    ...
    # Save it so you never have to train this exact data again
