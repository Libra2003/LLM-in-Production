...
print("Step 5: Scaled softmax attenton_scores for each vecotr")
...
print("Step 9: We assume we trained the heads of the attention sub-layer")
...
print("shhape of one head", z0h1.shape, "dimension of 8 heads", 64 * 8)

print("Step 10: Concatenate heads 1 to 8 get the original 8x64=512 output dim")
